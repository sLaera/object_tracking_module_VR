...
laryngoscope_obj_name_obj_id = {
    'laryngoscope': 1
}

laryngoscope_symmetry_obj = {
    'laryngoscope': 1
}
...
def get_obj_info(dataset_name):
    if dataset_name not in ['lmo', 'ycbv', 'tless', 'tudl', 'hb', 'icbin', 'itodd', 'laryngoscope', 'marker']:
