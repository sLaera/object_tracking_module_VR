...
`export PYTHONPATH=$PYTHONPATH:"/mnt/d/Uni/Tesi/3dObject traking projects/ZebraPose/Binary_Code_GT_Generator/Render_GT_Color_Mesh_to_GT_Img/Render_Python_API/build/lib.linux-x86_64-3.10"`
`export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:"/mnt/d/Uni/Tesi/3dObject traking projects/ZebraPose/Binary_Code_GT_Generator/Render_GT_Color_Mesh_to_GT_Img/build"`
...
before that go to calc_model_info.py. set the correct parameters and run

`python3 ../bop_toolkit/scripts/calc_model_info.py`

then execute

`python3 generate_mesh_with_GT_color_for_BOP.py "/mnt/d/Uni/Tesi/3dObject traking projects/ZebraPose/BOP ROOT" laryngoscope 2 16 "/mnt/d/Uni/Tesi/3dObject traking projects/ZebraPose/Binary_Code_GT_Generator/Generate_Mesh_with_GT_Color/build/Generate_Mesh_with_GT_Color"`
...
`python3 generate_training_labels_for_BOP.py --bop_path "/mnt/d/Uni/Tesi/3dObject traking projects/ZebraPose/BOP ROOT" --dataset_name laryngoscope --force_rewrite True --is_training_data True --data_folder train_synth --start_obj_id 0 --end_obj_id 1`
